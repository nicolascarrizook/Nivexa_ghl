...
-- =====================================================
-- Versión corregida compatible con estructura existente
...
CREATE TABLE IF NOT EXISTS inter_project_loans (
...
CREATE INDEX IF NOT EXISTS idx_inter_project_loans_lender ON inter_project_loans(lender_project_id);
CREATE INDEX IF NOT EXISTS idx_inter_project_loans_borrower ON inter_project_loans(borrower_project_id);
CREATE INDEX IF NOT EXISTS idx_inter_project_loans_status ON inter_project_loans(loan_status);
CREATE INDEX IF NOT EXISTS idx_inter_project_loans_due_date ON inter_project_loans(due_date);

-- Trigger para updated_at
DROP TRIGGER IF EXISTS update_inter_project_loans_updated_at ON inter_project_loans;
...
CREATE INDEX IF NOT EXISTS idx_loan_installments_status ON loan_installments(payment_status);
CREATE INDEX IF NOT EXISTS idx_loan_installments_due_date ON loan_installments(due_date);

-- Trigger para updated_at
DROP TRIGGER IF EXISTS update_loan_installments_updated_at ON loan_installments;
...
-- Índices
CREATE INDEX IF NOT EXISTS idx_bank_accounts_project ON bank_accounts(project_id);
...
-- Índices
CREATE INDEX IF NOT EXISTS idx_bank_account_transfers_from ON bank_account_transfers(from_account_id);
CREATE INDEX IF NOT EXISTS idx_bank_account_transfers_to ON bank_account_transfers(to_account_id);
CREATE INDEX IF NOT EXISTS idx_bank_account_transfers_date ON bank_account_transfers(transfer_date);
CREATE INDEX IF NOT EXISTS idx_bank_account_transfers_loan ON bank_account_transfers(related_loan_id);
CREATE INDEX IF NOT EXISTS idx_bank_account_transfers_type ON bank_account_transfers(transfer_type);
...
-- Actualizar el CHECK constraint para incluir nuevos tipos de movimiento
...
ALTER TABLE cash_movements ADD CONSTRAINT cash_movements_movement_type_check CHECK (
...
DROP TRIGGER IF EXISTS update_loan_balance_trigger ON loan_installments;
...
DROP TRIGGER IF EXISTS update_bank_account_balance_trigger ON bank_account_transfers;
...
DROP POLICY IF EXISTS "Enable read access for authenticated users" ON inter_project_loans;
...
DROP POLICY IF EXISTS "Enable read access for authenticated users" ON bank_account_transfers;
