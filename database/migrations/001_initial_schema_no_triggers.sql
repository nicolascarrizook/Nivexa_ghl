-- Initial Schema Migration for Nivexa (Without Triggers)
...
-- Note: Triggers are not included in this version since they already exist
-- The update_updated_at_column() function and triggers were created previously