...
import StatCard from "@/design-system/components/data-display/StatCard/StatCard";
          ...
          <div className="px-6 py-6">
            {loading ? (
              ...
              <EmptyState
                ...
                description={
                  providers.length === 0
                    ? "Comienza agregando tu primer proveedor para gestionar tus compras y servicios"
